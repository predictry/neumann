...
#
#     print '\t'.join(['Tenant'.ljust(20), 'TotalItems'.ljust(10), 'AL-1-RSR'.ljust(10), 'AL-3-RSR'.ljust(10),
#                      'AL-5-RSR'.ljust(10),
#                      'AVG-RS'.ljust(10)])
#
...
#                 avg_results = 0
#
#             print '\t'.join([tenant.ljust(20), '{:,}'.format(n).ljust(10), '{0:.2%}'.format(one_rate).ljust(10),
